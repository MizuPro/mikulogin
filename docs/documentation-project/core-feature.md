...
## Deskripsi Umum
Modul `@mikulogin/core` adalah fondasi utama dari ekosistem Mikulogin. Paket ini bersifat murni TypeScript tanpa ketergantungan pada ORM atau kerangka kerja antarmuka tertentu. Modul ini bertanggung jawab untuk menentukan kontrak antarmuka data (`DatabaseAdapter`, `User`, `Session`, `PasswordResetToken`) dan menyediakan fungsi utilitas keamanan (hashing password dan pembuatan token sesi).

## Komponen Utama & Logika

### 1. Tipe Data Inti (Interfaces)
Didefinisikan di [`packages/core/src/types.ts`](file:///e:/_BELAJAR%20PROGRAMMING_/github/mikulogin-package/packages/core/src/types.ts#L5-L75):
...
- **`DatabaseAdapter`** ([types.ts#L28-L75](file:///e:/_BELAJAR%20PROGRAMMING_/github/mikulogin-package/packages/core/src/types.ts#L28-L75)):
  ...
  - `createPasswordResetToken(userId, token, expiresAt)`: Menyimpan token reset kata sandi baru. ([types.ts#L61-L65](file:///e:/_BELAJAR%20PROGRAMMING_/github/mikulogin-package/packages/core/src/types.ts#L61-L65))
  - `consumePasswordResetToken(token)`: Mengambil dan menghapus token reset sekaligus (*single-use*) secara atomik. ([types.ts#L67-L71](file:///e:/_BELAJAR%20PROGRAMMING_/github/mikulogin-package/packages/core/src/types.ts#L67-L71))
  - `updateUserPassword(userId, newPasswordHash)`: Memperbarui hash kata sandi pengguna. ([types.ts#L73-L75](file:///e:/_BELAJAR%20PROGRAMMING_/github/mikulogin-package/packages/core/src/types.ts#L73-L75))
...
1. Aplikasi memanggil `hashPassword(plainTextPassword)` sebelum menyimpan pengguna baru atau memperbarui kata sandi. ([crypto.ts#L10](file:///e:/_BELAJAR%20PROGRAMMING_/github/mikulogin-package/packages/core/src/crypto.ts#L10))
...
4. Token disimpan atau dikonsumsi melalui implementasi `DatabaseAdapter`. ([types.ts#L28](file:///e:/_BELAJAR%20PROGRAMMING_/github/mikulogin-package/packages/core/src/types.ts#L28))

---

## Daftar File yang Terlibat
- [`packages/core/src/types.ts`](file:///e:/_BELAJAR%20PROGRAMMING_/github/mikulogin-package/packages/core/src/types.ts) - Definisi antarmuka TypeScript untuk User, Session, PasswordResetToken, dan DatabaseAdapter.
